...
type CustomerData = { customerName: string; customerPhone: string; customerEmail: string; vehicleMake: string; vehicleModel: string; vehicleYear: string; vehicleColor: string; vehiclePlate: string; vehicleVinLast6: string; odometerKm: string };
const emptyCustomer: CustomerData = { customerName: "", customerPhone: "", customerEmail: "", vehicleMake: "", vehicleModel: "", vehicleYear: "", vehicleColor: "", vehiclePlate: "", vehicleVinLast6: "", odometerKm: "" };
